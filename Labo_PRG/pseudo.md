...
Le programme demandé doit dans un 1er temps calculer la distance entre le robot et l’élément dans les directions x et y. Ensuite, la vitesse du robot sur la route et le terrain rocheux, puis calculer la longueur de L2. Finalement afficher le temps total que le robot va prendre pour arriver au point B. 

# Pseudo Code – Calcul du temps de trajet

    1. Afficher un message de Bienvenue
    2. Saisir les valeurs connus et vérifier si les données sont correctes
    ...
    3. Calculer la longueur du deuxième segment "L2"
    ...
    4. Calculer le temps pour parcourir chaque segment
